...
public class BatchControllerTest {
    ...
    @Test
    public void testGetBatchDetails1() {
        // Mock data
        Long batchId = 1L;
        Map<String, Long> batchDetails = new HashMap<>();
        batchDetails.put("totalEmployees", 10L);
    ...
    public void testGetBatchName() {
        // Mock data
        Long batchId = 1L;
        Map<String, String> batchName = new HashMap<>();
        batchName.put("batchName", "Test Batch");

        // Mock the behavior of getBatchName() method in the BatchService
        when(batchService.getBatchName(batchId)).thenReturn(batchName);

        // Perform the controller method
        Map<String, String> result = batchController.getBatchName(batchId);

        // Verify the result
        assertEquals(batchName, result);

        // Verify that batchService.getBatchName was called with the correct argument
        verify(batchService, times(1)).getBatchName(batchId);
    }
    ...
    public void testGetBatchesByEmployeeId() {
        // Mock data
        Long employeeId = 1L;
        List<Map<String, Object>> batches = Arrays.asList(
                new HashMap<String, Object>() {{ put("batchId", 101); put("batchName", "Batch A"); }},
                new HashMap<String, Object>() {{ put("batchId", 102); put("batchName", "Batch B"); }}
        );

        // Mock the behavior of getBatchesByEmployeeId() method in the BatchService
        when(batchService.getBatchesByEmployeeId(employeeId)).thenReturn(batches);

        // Perform the controller method
        List<Map<String, Object>> result = batchController.getBatchesByEmployeeId(employeeId);

        // Verify the result
        assertEquals(batches, result);

        // Verify that batchService.getBatchesByEmployeeId was called with the correct argument
        verify(batchService, times(1)).getBatchesByEmployeeId(employeeId);
    }
