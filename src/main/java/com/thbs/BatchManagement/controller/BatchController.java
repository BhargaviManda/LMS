...
public class BatchController { 
    ...
    @GetMapping("/batch-name/{batchId}")
    public Map<String, String> getBatchName(@PathVariable Long batchId) {
        return batchService.getBatchName(batchId);
    }
